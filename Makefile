...
UAE_CFLAGS += -Wall -std=gnu99 -D_GNU_SOURCE -pipe -Wno-unused-variable -Wno-unused-but-set-variable -Wno-pointer-sign -Wno-unused-function -O0 -g3
UAE_LDFLAGS += -lz
...
ifeq ($(GUI_BACKEND),gui-gtk)
	...
	GUI_LDFLAGS = -lSDL_ttf -lSDL_image -lSDL
endif
