...
{ _T("X"), 0, 0, 0, 0, 0, size, id, 0, 0, flags, (grp << 16) | num, 0, NULL, crc32, { a, b, c, d, e }, NULL },
#define ALTROMPN(id,grp,num,size,flags,pn,crc32,a,b,c,d,e) \
{ _T("X"), 0, 0, 0, 0, 0, size, id, 0, 0, flags, (grp << 16) | num, 0, pn, crc32, { a, b, c, d, e }, NULL },

static struct romdata roms[] = {
/* Format of the regular ROM initialization: (Please keep valid!)
 *  { *name,                                                ver,rev,subv,subr, *model,                      size, id, cpu, cloanto, type,        group,ttl,*partnumber,           crc32, { sha1[5]                                                    }, *configname } */
	{ _T("Cloanto Amiga Forever ROM key"),                    0,  0,  0,   0, NULL,                         2069,  0, 0,     1, ROMTYPE_KEY,         0,  0, NULL,            0x869ae1b1, { 0x801bbab3, 0x2e3d3738, 0x6dd1636d, 0x4f1d6fa7, 0xe21d5874 }, NULL },
	{ _T("KS ROM v1.0 (A1000)(NTSC)"),                        1,  0,  1,   0, _T("A1000\0"),              262144,  1, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0x299790ff, { 0x00C15406, 0xBEB4B8AB, 0x1A16AA66, 0xC05860E1, 0xA7C1AD79 }, NULL },
	{ _T("KS ROM v1.1 (A1000)(NTSC)"),                        1,  1, 31,  34, _T("A1000\0"),              262144,  2, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0xd060572a, { 0x4192C505, 0xD130F446, 0xB2ADA6BD, 0xC91DAE73, 0x0ACAFB4C }, NULL },
	{ _T("KS ROM v1.1 (A1000)(PAL)"),                         1,  1, 31,  34, _T("A1000\0"),              262144,  3, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0xec86dae2, { 0x16DF8B5F, 0xD524C5A1, 0xC7584B24, 0x57AC15AF, 0xF9E3AD6D }, NULL },
	{ _T("KS ROM v1.2 (A1000)"),                              1,  2, 33, 166, _T("A1000\0"),              262144,  4, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0x9ed783d0, { 0x6A7BFB5D, 0xBD6B8F17, 0x9F03DA84, 0xD8D95282, 0x67B6273B }, NULL },
	{ _T("KS ROM v1.2 (A500,A1000,A2000)"),                   1,  2, 33, 180, _T("A500\0A1000\0A2000\0"), 262144,  5, 0,     0, ROMTYPE_KICK,        0,  0, _T("315093-01"), 0xa6ce1636, { 0x11F9E62C, 0xF299F721, 0x84835B7B, 0x2A70A163, 0x33FC0D88 }, NULL },
	{ _T("KS ROM v1.3 (A500,A1000,A2000)"),                   1,  3, 34,   5, _T("A500\0A1000\0A2000\0"), 262144,  6, 0,     0, ROMTYPE_KICK,        0,  0, _T("315093-02"), 0xc4f0f55f, { 0x891E9A54, 0x7772FE0C, 0x6C19B610, 0xBAF8BC4E, 0xA7FCB785 }, NULL },
	{ _T("KS ROM v2.04 (A500+)"),                             2,  4, 37, 175, _T("A500+\0"),              524288,  7, 0,     0, ROMTYPE_KICK,        0,  0, _T("390979-01"), 0xc3bdb240, { 0xC5839F5C, 0xB98A7A89, 0x47065C3E, 0xD2F14F5F, 0x42E334A1 }, NULL },
	{ _T("KS ROM v2.05 (A600)"),                              2,  5, 37, 299, _T("A600\0"),               524288,  8, 0,     0, ROMTYPE_KICK,        0,  0, _T("391388-01"), 0x83028fb5, { 0x87508DE8, 0x34DC7EB4, 0x7359CEDE, 0x72D2E3C8, 0xA2E5D8DB }, NULL },
	{ _T("KS ROM v2.05 (A600HD)"),                            2,  5, 37, 300, _T("A600HD\0A600\0"),       524288,  9, 0,     0, ROMTYPE_KICK,        0,  0, _T("391304-01"), 0x64466c2a, { 0xF72D8914, 0x8DAC39C6, 0x96E30B10, 0x859EBC85, 0x9226637B }, NULL },
	{ _T("KS ROM v2.05 (A600HD)"),                            2,  5, 37, 350, _T("A600HD\0A600\0"),       524288, 10, 0,     0, ROMTYPE_KICK,        0,  0, _T("391304-02"), 0x43b0df7b, { 0x02843C42, 0x53BBD29A, 0xBA535B0A, 0xA3BD9A85, 0x034ECDE4 }, NULL },
	{ _T("KS ROM v3.0 (A1200)"),                              3, 0,  39, 106, _T("A1200\0"),              524288, 11, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0x6c9b07d2, { 0x70033828, 0x182FFFC7, 0xED106E53, 0x73A8B89D, 0xDA76FAA5 }, NULL },
	{ _T("KS ROM v3.0 (A4000)"),                              3,  0, 39, 106, _T("A4000\0"),              524288, 12, 2 | 4, 0, ROMTYPE_KICK,        0,  0, NULL,            0x9e6ac152, { 0xF0B4E9E2, 0x9E12218C, 0x2D5BD702, 0x0E4E7852, 0x97D91FD7 }, NULL },
	{ _T("KS ROM v3.1 (A4000)"),                              3,  1, 40,  70, _T("A4000\0"),              524288, 13, 2 | 4, 0, ROMTYPE_KICK,        0,  0, NULL,            0x2b4566f1, { 0x81c631dd, 0x096bbb31, 0xd2af9029, 0x9c76b774, 0xdb74076c }, NULL },
	{ _T("KS ROM v3.1 (A500,A600,A2000)"),                    3,  1, 40,  63, _T("A500\0A600\0A2000\0"),  524288, 14, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0xfc24ae0d, { 0x3B7F1493, 0xB27E2128, 0x30F989F2, 0x6CA76C02, 0x049F09CA }, NULL },
	{ _T("KS ROM v3.1 (A1200)"),                              3,  1, 40,  68, _T("A1200\0"),              524288, 15, 1,     0, ROMTYPE_KICK,        0,  0, NULL,            0x1483a091, { 0xE2154572, 0x3FE8374E, 0x91342617, 0x604F1B3D, 0x703094F1 }, NULL },
	{ _T("KS ROM v3.1 (A4000)"),                              3,  1, 40,  68, _T("A4000\0"),              524288, 16, 2 | 4, 0, ROMTYPE_KICK,        0,  0, NULL,            0xd6bae334, { 0x5FE04842, 0xD04A4897, 0x20F0F4BB, 0x0E469481, 0x99406F49 }, NULL },
	{ _T("KS ROM v3.1 (A4000T)"),                             3,  1, 40,  70, _T("A4000T\0"),             524288, 17, 2 | 4, 0, ROMTYPE_KICK,        0,  0, NULL,            0x75932c3a, { 0xB0EC8B84, 0xD6768321, 0xE01209F1, 0x1E6248F2, 0xF5281A21 }, NULL },
	{ _T("CD32 KS ROM v3.1"),                                 3,  1, 40,  60, _T("CD32\0"),               524288, 18, 1,     0, ROMTYPE_KICKCD32,    0,  0, NULL,            0x1e62d4a5, { 0x3525BE88, 0x87F79B59, 0x29E017B4, 0x2380A79E, 0xDFEE542D }, NULL },
	{ _T("CD32 extended ROM"),                                3,  1, 40,  60, _T("CD32\0"),               524288, 19, 1,     0, ROMTYPE_EXTCD32,     0,  0, NULL,            0x87746be2, { 0x5BEF3D62, 0x8CE59CC0, 0x2A66E6E4, 0xAE0DA48F, 0x60E78F7F }, NULL },
	{ _T("CDTV extended ROM v1.00"),                          1,  0,  1,   0, _T("CDTV\0"),               262144, 20, 0,     0, ROMTYPE_EXTCDTV,     0,  0, NULL,            0x42baa124, { 0x7BA40FFA, 0x17E500ED, 0x9FED041F, 0x3424BD81, 0xD9C907BE }, NULL },
	{ _T("CDTV/A570 extended ROM v2.30"),                     2, 30,  2,  30, _T("CDTV\0"),               262144, 21, 0,     0, ROMTYPE_EXTCDTV,     0,  0, _T("391298-01"), 0x30b54232, { 0xED7E461D, 0x1FFF3CDA, 0x321631AE, 0x42B80E3C, 0xD4FA5EBB }, NULL },
	{ _T("CDTV extended ROM v2.07"),                          2,  7,  2,   7, _T("CDTV\0"),               262144, 22, 0,     0, ROMTYPE_EXTCDTV,     0,  0, NULL,            0xceae68d2, { 0x5BC114BB, 0xA29F60A6, 0x14A31174, 0x5B3E2464, 0xBFA06846 }, NULL },
	{ _T("CD32 MPEG Cartridge ROM"),                          3,  1, 40,  30, _T("CD32FMV\0"),            262144, 23, 1,     0, ROMTYPE_CD32CART,    0,  0, NULL,            0xc35c37bf, { 0x03ca81c7, 0xa7b259cf, 0x64bc9582, 0x863eca0f, 0x6529f435 }, NULL },
	{ _T("A1000 bootstrap ROM"),                              0,  0,  0,   0, _T("A1000\0"),               65536, 24, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0x0b1ad2d0, { 0xBA93B8B8, 0x5CA0D83A, 0x68225CC3, 0x3B95050D, 0x72D2FDD7 }, NULL },
	{ _T("Freezer: Action Replay Mk I v1.50"),                1, 50,  1,  50, _T("AR\0"),                  65536, 25, 0,     0, ROMTYPE_AR,          0,  1, NULL,            0xd4ce0675, { 0x843B433B, 0x2C56640E, 0x045D5FDC, 0x854DC6B1, 0xA4964E7C }, NULL },
	{ _T("Freezer: Action Replay Mk II v2.05"),               2,  5,  2,   5, _T("AR\0"),                 131072, 26, 0,     0, ROMTYPE_AR,          0,  1, NULL,            0x1287301f, { 0xF6601DE8, 0x888F0050, 0x72BF562B, 0x9F533BBC, 0xAF1B0074 }, NULL },
	{ _T("Freezer: Action Replay Mk II v2.12"),               2, 12,  2,  12, _T("AR\0"),                 131072, 27, 0,     0, ROMTYPE_AR,          0,  1, NULL,            0x804d0361, { 0x3194A07A, 0x0A82D8B5, 0xF2B6AEFA, 0x3CA581D6, 0x8BA8762B }, NULL },
	{ _T("Freezer: Action Replay Mk II v2.14"),               2, 14,  2,  14, _T("AR\0"),                 131072, 28, 0,     0, ROMTYPE_AR,          0,  1, NULL,            0x49650e4f, { 0x255D6DF6, 0x3A4EAB0A, 0x838EB1A1, 0x6A267B09, 0x59DFF634 }, NULL },
	{ _T("Freezer: Action Replay Mk III v3.09"),              3,  9,  3,   9, _T("AR\0"),                 262144, 29, 0,     0, ROMTYPE_AR,          0,  1, NULL,            0x0ed9b5aa, { 0x0FF3170A, 0xBBF0CA64, 0xC9DD93D6, 0xEC0C7A01, 0xB5436824 }, NULL },
	{ _T("Freezer: Action Replay Mk III v3.17"),              3, 17,  3,  17, _T("AR\0"),                 262144, 30, 0,     0, ROMTYPE_AR,          0,  1, NULL,            0xc8a16406, { 0x5D4987C2, 0xE3FFEA8B, 0x1B02E314, 0x30EF190F, 0x2DB76542 }, NULL },
	{ _T("KS ROM v3.1 (A4000)(Cloanto)"),                     3,  1, 40,  68, _T("A4000\0"),              524288, 31, 2 | 4, 1, ROMTYPE_KICK,        0,  0, NULL,            0x43b6dd22, { 0xC3C48116, 0x0866E60D, 0x085E436A, 0x24DB3617, 0xFF60B5F9 }, NULL },
	{ _T("KS ROM v1.3 (A3000)(SK)"),                          1,  3, 34,   5, _T("A3000\0"),              262144, 32, 0,     0, ROMTYPE_KICK,        0,  0, NULL,            0xe0f37258, { 0xC39BD909, 0x4D4E5F4E, 0x28C1411F, 0x30869504, 0x06062E87 }, NULL },
	{ _T("Arcadia SportTime Table Hockey v2.1"),              0,  0,  0,   0, _T("ARCADIA\0"),                 0, 33, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia SportTime Bowling v2.1"),                   0,  0,  0,   0, _T("ARCADIA\0"),                 0, 34, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia World Darts v2.1"),                         0,  0,  0,   0, _T("ARCADIA\0"),                 0, 35, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Magic Johnson's Fast Break v2.8"),          0,  0,  0,   0, _T("ARCADIA\0"),                 0, 36, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Leader Board Golf v2.4"),                   0,  0,  0,   0, _T("ARCADIA\0"),                 0, 37, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Leader Board Golf"),                        0,  0,  0,   0, _T("ARCADIA\0"),                 0, 38, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Ninja Mission v2.5"),                       0,  0,  0,   0, _T("ARCADIA\0"),                 0, 39, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Road Wars v2.3"),                           0,  0,  0,   0, _T("ARCADIA\0"),                 0, 40, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Sidewinder v2.1"),                          0,  0,  0,   0, _T("ARCADIA\0"),                 0, 41, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Spot v2.0"),                                0,  0,  0,   0, _T("ARCADIA\0"),                 0, 42, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Space Ranger v2.0"),                        0,  0,  0,   0, _T("ARCADIA\0"),                 0, 43, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Xenon v2.3"),                               0,  0,  0,   0, _T("ARCADIA\0"),                 0, 44, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia World Trophy Soccer v3.0"),                 0,  0,  0,   0, _T("ARCADIA\0"),                 0, 45, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia SportTime Table Hockey v2.1"),              0,  0,  0,   0, _T("ARCADIA\0"),                 0, 33, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia SportTime Bowling v2.1"),                   0,  0,  0,   0, _T("ARCADIA\0"),                 0, 34, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia World Darts v2.1"),                         0,  0,  0,   0, _T("ARCADIA\0"),                 0, 35, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Magic Johnson's Fast Break v2.8"),          0,  0,  0,   0, _T("ARCADIA\0"),                 0, 36, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	...
	{ _T("Arcadia Xenon v2.3"),                               0,  0,  0,   0, _T("ARCADIA\0"),                 0, 44, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia World Trophy Soccer v3.0"),                 0,  0,  0,   0, _T("ARCADIA\0"),                 0, 45, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Blastaball v2.1"),                          0,  0,  0,   0, _T("ARCADIA\0"),                 0, 78, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Delta Command"),                            0,  0,  0,   0, _T("ARCADIA\0"),                 0, 79, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Pharaohs Match"),                           0,  0,  0,   0, _T("ARCADIA\0"),                 0, 80, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia SportTime Table Hockey"),                   0,  0,  0,   0, _T("ARCADIA\0"),                 0, 81, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia World Darts (bad)"),                        0,  0,  0,   0, _T("ARCADIA\0"),                 0, 82, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia Magic Johnson's Fast Break v2.7"),          0,  0,  0,   0, _T("ARCADIA\0"),                 0, 83, 0,     0, ROMTYPE_ARCADIAGAME, 0,  2, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	...
	{ _T("Cloanto Amiga Forever 2006 ROM key"),               0,  0,  0,   0, NULL,                          750, 48, 0,     1, ROMTYPE_KEY,         0,  0, NULL,            0xb01c4b56, { 0xbba8e5cd, 0x118b8d92, 0xafed5693, 0x5eeb9770, 0x2a662d8f }, NULL },
	{ _T("Arcadia OnePlay 2.11"),                             0,  0,  0,   0, _T("ARCADIA\0"),                 0, 49, 0,     0, ROMTYPE_ARCADIABIOS, 0,  0, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia TenPlay 2.11"),                             0,  0,  0,   0, _T("ARCADIA\0"),                 0, 50, 0,     0, ROMTYPE_ARCADIABIOS, 0,  0, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia TenPlay 2.20"),                             0,  0,  0,   0, _T("ARCADIA\0"),                 0, 75, 0,     0, ROMTYPE_ARCADIABIOS, 0,  0, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	{ _T("Arcadia OnePlay 3.00"),                             0,  0,  0,   0, _T("ARCADIA\0"),                 0, 51, 0,     0, ROMTYPE_ARCADIABIOS, 0,  0, NULL,                     0, {          0,          0,          0,          0,          0 }, NULL },
	...
	/* Format of the ALTROM() macro: (Please keep valid!)
	 *    (id,grp,num,   size, flags,                                       crc32,      sha1[0],    sha1[1],    sha1[2],    sha1[3],    sha1[4]   ) */
...
int load_keyring (struct uae_prefs *p, const TCHAR *path)
{
	...
	free_keyring ();
	//FIXME: keybuf = target_load_keyfile (p, path, &keysize, tmp);
...
static struct romdata *checkromdata (const uae_u8 *sha1, int size, uae_u32 mask)
{
	int i = 0;
	while (roms[i].name) {
		if (!notcrc32(roms[i].crc32) && roms[i].size >= (uae_u32)size) {
			if (roms[i].type & mask) {
...
void romwarning (const int *ids)
{
	...
	if (exp)
		gui_message ("One of the following expansion boot ROMs is required:\nCheck the System ROM path in the Paths panel and click Rescan ROMs.");
	else
